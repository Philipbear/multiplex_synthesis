"""
masst_matches.py
This script generates and visualizes the distribution of MASST matches per USI or reference spectrum.
It includes functions to generate match counts, plot distributions, and merge with spectral information.
"""
