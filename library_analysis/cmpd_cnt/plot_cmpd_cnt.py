...
def plot_product_comparison():
    ...
    valid_data = reaction_df.dropna(subset=['expected_cmpd_no', 'observed_cmpd_no']).copy()
    ...
    valid_data['cumulative_expected'] = valid_data['expected_cmpd_no'].cumsum()
    valid_data['cumulative_observed'] = valid_data['observed_cmpd_no'].cumsum()
    ...
    total_expected = valid_data['expected_cmpd_no'].sum()
    total_observed = valid_data['observed_cmpd_no'].sum()
