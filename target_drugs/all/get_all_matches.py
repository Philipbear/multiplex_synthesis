...
def process_file(file, result_dir):
    ...
    try:
        ...
        df['name'] = file.split('target_')[1].split('_matches.tsv')[0]
...
def get_all_matches(result_dir, out_path, n_cores=None):
    # Get all TSV files
...
if __name__ == "__main__":
    ...
    # get_all_matches('masst_0.7_4', 'data/all_masst_matches_0.7_4.tsv')
    get_all_matches('masst_0.7_3', 'data/all_masst_matches_0.7_3.tsv')
