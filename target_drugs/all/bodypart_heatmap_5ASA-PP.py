...
def plot_bodypart_heatmap(input_data, output_path):
    ...
    desired_column_order = ['5-ASA', 'Phenylpropionate', '5-ASA-phenylpropionate']
    ...
    clustermap = sns.clustermap(data_log,
                               ...
                               annot=False,
                               robust=True,
                               figsize=(2.3, 3.5),  # Adjusted figure size for transposed layout
...
if __name__ == '__main__':
    ...
    compound_bodypart_data = compound_bodypart_data[compound_bodypart_data['name'].isin(['5-ASA', 'Phenylpropionate', '5-ASA-phenylpropionate'])].reset_index(drop=True)

    # Generate and save the heatmap
    plot_bodypart_heatmap(
        compound_bodypart_data, 
        'target_drugs/all/plots/bodypart_heatmap_5ASA-PP.svg'
    )