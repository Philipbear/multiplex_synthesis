...
if __name__ == "__main__":
    ...
    MZ_1 = 136.0393  # 5ASA conjugate
    MZ_2 = 154.0499  # 5ASA conjugate
    
    out_path = 'target_drugs/5ASA_conjugates/data'
    get_drug_and_conjugates(out_path, drug_name='5-Aminosalicylic acid')
    
    filter_masst_redu_df('5-Aminosalicylic acid', out_path)
