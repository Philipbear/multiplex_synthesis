...
if __name__ == '__main__':
    ...
    std_xic = get_xics('target_drugs/5-ASA-PP/mzml/std.mzML', 
                       target_mz, mz_tol=target_mz * mz_ppm / 1e6)
    
    # Get XIC data for biological sample
    bio_xic = get_xics('target_drugs/5-ASA-PP/mzml/sample.mzML', 
                       target_mz, mz_tol=target_mz * mz_ppm / 1e6)
    ...
    plot_xics([std_xic, bio_xic], 
            #   labels=[f'Chemical\nstandard', f'IBD feces\nsample'],
              ...
              rt_range=(3.2, 6.2), 
              save=True, name='target_drugs/5-ASA-PP/plots/xics.svg')